...
def classify_images(images_dir, results_dic, model):
    ...
    for key in results_dic:
        # Set variable model_label to return from using the classifier function
        ...
        # extend list function to add the model_label and value of 1 to: results_dic
        # value 1 indicates a match between pet image label and the classifier label
