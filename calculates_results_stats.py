...
def calculates_results_stats(results_dic):
    ...
    # set counters to 0 and increment them later
    ...
    for key in results_dic:
        ...
        if results_dic[key][2] == 1:
            ...
            # pet image label indicates is-a-dog --AND-- 
            # the pet image label and the classifier label match.
            # then increments 'n_correct_breed' by 1
    ...
    if results_stats_dic['n_dogs_img'] > 0:
        results_stats_dic['pct_correct_breed'] = 100.0* (results_stats_dic['n_correct_breed'] /
                                                         results_stats_dic['n_dogs_img'])
    else:
    ...
    # if no 'not a dog' images were submitted 
